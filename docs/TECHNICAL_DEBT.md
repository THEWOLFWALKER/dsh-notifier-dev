...
状态更新：2026-09-12。v0.9.7 已发布（Telegram PR #22 + QQ Issue #23 修复收口，`npm test` 为 `1548`，1548 pass）。上一线 v0.9.6（零配置首访，1544 pass）。此前的 R1–R5 修复列车于 R5（v0.9.5，W13）2026-09-05 收口，基线 `1531`。剩余事项只是真机/宿主验证和外部目录缓存刷新，不应被误读为待实现的新功能。
