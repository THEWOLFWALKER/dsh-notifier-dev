...
- Current test baseline: **1339** total (1338 pass + 1 skip). The published v0.8.6 contract remains **909**; package/version stays `0.8.6`, and this development line is unreleased.
...
- `npm test` (current development line, 2026-08-27): `1339 total` = `1338 pass + 1 skip`.
