...
- Current test baseline: **1346** total (1345 pass + 1 skip). The published v0.8.6 contract remains **909**; package/version stays `0.8.6`, and this development line is unreleased.
...
- `npm test` (current development line, 2026-08-27): `1346 total` = `1345 pass + 1 skip`.
