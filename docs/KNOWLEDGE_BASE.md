...
- Test baseline: `1349` total on the current development line (`codex/stage5-wechat-ilink-hardening`, 1348 pass + 1 skip after final maintenance hardening). The published v0.8.6 release retains `909` as its documented test count until a release cycle updates version and count together.
