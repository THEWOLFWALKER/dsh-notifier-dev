...
- 当前发布线：`codex/admin-zero-config-onboarding`，包版本字段 `0.9.6`（零配置首访已发布 2026-09-12）；公共 GitHub 源码镜像（`main`）已推送 v0.9.6，npm registry `latest` 为 `0.9.6`。
- 当前测试：`1544`（1544 pass，v0.9.6 发布基线）。历史 npm `0.8.6` 契约为 909、`0.9.0` 为 1352、v0.9.5 为 1531；按版本区分。
