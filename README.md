...
The published `dsh-notifier@0.8.6` contract is 909 tests. The current development line is 1349 tests (1348 pass + 1 skip); it is unreleased and has not had real-device or host-protocol validation.
...
test/                 909 tests in the published v0.8.6 package; current development line: 1349 (1348 pass + 1 skip)
```
...
```bash
npm test          # published v0.8.6 contract: 909 tests; current development line: 1349 (1348 pass + 1 skip)
```
