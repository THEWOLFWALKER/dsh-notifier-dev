...
- Handoff: Documentation-only synchronization complete; current HEAD remains unreleased at 0.8.6/1174 (1173 pass + 1 skip), with real-device/host protocol validation pending. Commit after validation.
